...
public static class IEnumerableExtensions
{
        ...
        string fields)
    {
        ...
        // create a list with PropertyInfo objects on TSouruce. Reflection is
        // expensive, so rather than doingn it for each object in the list, we do
        ...
        else
        {
            ...
            foreach (var field in fieldsAfterSplit)
            {
                ...
                // flag overwirtes the already-existing binding flags.
        ...
        foreach (TSource sourceObject in source)
        {
            ...
            // we run throuhgh the list
            foreach (var propertyInfo in propertyInfoList)
            {
                // GetValue return the valueu of the property on the source object
            ...
            // add the ExpandoObject to the lists
